...
$category = [
    "title"=>"Sensor Udara",
    "subtitle"=>"Monitoring kualitas udara dengan sensor presisi tinggi"
];
?>
    ...
    <section class="py-4 bg-primary text-white">
        <div class="container text-center">
            <h1 class="display-5 fw-bold mb-4">
                <i class="fas fa-wind me-2"></i><?= $category['title']; ?>
            </h1>
...
<div class="alert alert-warning text-center">
    ...
    <p class="mb-0">
        Produk Sensor Udara belum tersedia.
    </p>
